...
CREATE TABLE IF NOT EXISTS `youtube`.`canales` (
  ...
  PRIMARY KEY (`id_canal`, `id_usuario_creador`),
...
CREATE TABLE IF NOT EXISTS `youtube`.`comentarios_videos` (
  ...
  PRIMARY KEY (`id_comentario`, `videos_id_video`),
  INDEX `fk_usuarios_has_videos_videos2_idx` (`videos_id_video` ASC) VISIBLE,
  INDEX `fk_usuarios_has_videos_usuarios2_idx` (`usuarios_id_usuario` ASC) VISIBLE,
